...
public class OilAPI {
    ...
    public void getOil(final Context context, final LinearLayout linearLayout, final TextView name, final TextView source, final TextView price, final TextView date, final ProgressBar progressBar) {
        ...
        if (Connection.isNetworkAvailable(context)) {
            ...
            String URL = "https://www.quandl.com/api/v3/datasets/OPEC/ORB.json?order=desc&column_index=1&api_key=zQethT3ZviT2xz34q3y5&limit=1";
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.GET, URL, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        Log.d("Oil API", "onResponse: " + jsonResponse.optString("database_code") + " :" + jsonResponse.optString("name") + " :" + jsonResponse.optString("description") + " :" + date + "  :" + price);
                        ...
                        OilModel.Name.add(jsonResponse.optString("name"));
                        OilModel.Value.add(price1);
                        OilModel.Time.add(date1);
                        OilModel.Source.add(jsonResponse.optString("database_code"));
                        OilModel.Description.add(jsonResponse.optString("description"));
