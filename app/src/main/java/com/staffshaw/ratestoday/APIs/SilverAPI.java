...
public class SilverAPI {
    ...
    public void getSilver(final Context context, final LinearLayout linearLayout, final TextView name, final TextView source, final TextView price, final TextView date, final ProgressBar progressBar) {
        ...
        if (Connection.isNetworkAvailable(context)) {
            ...
            String URL = "https://www.quandl.com/api/v3/datasets/LBMA/SILVER.json?order=desc&column_index=1&api_key=zQethT3ZviT2xz34q3y5&limit=1";
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.GET, URL, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        Log.d("Silver API", "onResponse: " + jsonResponse.optString("database_code") + " :" + jsonResponse.optString("name") + " :" + jsonResponse.optString("description") + " :" + date + "  :" + price);
                        ...
                        SilverModel.Name.add(jsonResponse.optString("name"));
                        SilverModel.Value.add(price1);
                        SilverModel.Time.add(date1);
                        SilverModel.Source.add(jsonResponse.optString("database_code"));
                        SilverModel.Description.add(jsonResponse.optString("description"));
