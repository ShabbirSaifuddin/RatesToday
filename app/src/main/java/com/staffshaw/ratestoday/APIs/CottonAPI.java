...
public class CottonAPI {
    ...
    List<CottonModel> list = new ArrayList<>();

    public void getCotton(final Context context, final LinearLayout linearLayout, final TextView name, final TextView source, final TextView price, final TextView date, final ProgressBar progressBar) {
        ...
        if (Connection.isNetworkAvailable(context)) {
            ...
            String URL = "https://www.quandl.com/api/v3/datasets/ODA/PCOTTIND_USD.json?order=desc&column_index=1&api_key=zQethT3ZviT2xz34q3y5&limit=1";
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.GET, URL, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        String name2 = name1.substring(0, 31);
                        ...
                        list.add(new CottonModel(name2, price1, date1, jsonResponse.optString("database_code"), jsonResponse.optString("description")));

                        CottonModel.Name.add(name2);
                        CottonModel.Value.add(price1);
                        CottonModel.Time.add(date1);
                        CottonModel.Source.add(jsonResponse.optString("database_code"));
                        CottonModel.Description.add(jsonResponse.optString("description"));
